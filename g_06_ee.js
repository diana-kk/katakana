...
bottomArea.text(171, 270, 'エ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_epuronn.use().transform('t135, 420').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(150, 550, ['エ', 'プロン', '앞치마']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
