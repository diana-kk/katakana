...
bottomArea.text(171, 270, 'モ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_moderu.use().transform('t135 417').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 550, ['モ', 'デル', '모델']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
